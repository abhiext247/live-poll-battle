...
//               {pollOptions?.A}
//             </span>
//             <span>{hasVoted || votingEnded ? `${votes.A} votes (${percentA}%)` : `${votes.A} votes`}</span>
//           </div>
...
//               {pollOptions?.B}
//             </span>
//             <span>{hasVoted || votingEnded ? `${votes.B} votes (${percentB}%)` : `${votes.B} votes`}</span>
//           </div>
//           <div className="h-6 w-full bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
//             <motion.div 
...
//           <p>Vote to see detailed results</p>
//         </div>
//       )}
//     </motion.div>
//   );
