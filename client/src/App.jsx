...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-indigo-600 to-purple-700 text-white flex items-center justify-center p-4">
...
//       ) : (
//         <PollRoom userData={userData} onLeaveRoom={handleLeaveRoom} />
//       )}
