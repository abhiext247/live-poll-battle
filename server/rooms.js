...
//     const room_data = rooms.get(room);
    
//     // Check if user already exists with same socket ID
//     const existingUserIndex = room_data.users.findIndex(u => u.socketId === socketId);
    
//     if (existingUserIndex >= 0) {
//       // Update existing user
//       room_data.users[existingUserIndex] = {
//         ...room_data.users[existingUserIndex],
//         name,
//         lastActive: Date.now()
//       };
...
//   const now = Date.now();
//   const MAX_ROOM_AGE = 1000 * 60 * 60 * 24; // 24 hours
